...
export class NotificationUiConfig {
    constructor(
        ...
        public autoUpdateEnabled: boolean, // whether to auto-check for notifications each N seconds, to be rewritten with websockets
        ...
        public referenceTypeKeyPath: string, // path to get typeKey of related entity inside the notification object, used to navigate
        public referenceIdPath: string, // path to get id of related entity inside the notification object, used to navigate,
